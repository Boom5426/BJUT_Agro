...
# 根据生成的 txt 文件来测试性能
# np.savetxt(outdir + '/Drug_prediction.txt', prediction_result, fmt='%d', delimiter=' ')
# np.savetxt(outdir + '/Drug_GT.txt', ground_truth, fmt='%d', delimiter=' ')
...
TGT_stoi=np.load(data_path+"TGT_stoi.npy", allow_pickle=True).item()
TGT_itos=np.load(data_path+"TGT_itos.npy", allow_pickle=True)
